...
This tendency has a name: **sycophancy**. And while the most extreme versions have been reined in (early ChatGPT versions would enthusiastically endorse almost anything), the default tilt toward agreement is still there. It shows up as praise where critique would be more useful, as false confidence where honest uncertainty would be more accurate, and as a tendency to echo whatever framing you provide rather than questioning it.
